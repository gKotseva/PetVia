...
import { getBookings, getSchedule } from "../handlers/salonHandler";
...
export function Calendar() {
    ...
    useEffect(() => {
        const fetchSchedule = async () => {
            const bookings = await getBookings(1); // За конкретен салон
            const schedule = await getSchedule(1); // За конкретен салон
